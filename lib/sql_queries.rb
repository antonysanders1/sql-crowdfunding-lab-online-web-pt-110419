...
<<<<<<< HEAD
  "SELECT projects.title, (SUM(pledges.amount) - projects.funding_goal) AS extra FROM projects JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.title HAVING extra > -1;"
=======
...
>>>>>>> 93a27904f9b7cf9e297f7dc7f8b8acd7b88661be
end
